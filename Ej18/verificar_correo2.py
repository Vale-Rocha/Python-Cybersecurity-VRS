...
if response.status_code == 200:
            ...
            for i, brecha in enumerate(brechas[:3]):
                ...
                try:
                    ...
                    if detalle_resp.status_code == 200:
                        ...
                        logging.error(f"No se pudo obtener detalles de la brecha: {nombre}. Código: {detalle_resp.status_code}")
                except Exception as e:
                    logging.error(f"Error al consultar detalles de la brecha {nombre}: {e}")
    ...
    print(f"Consulta completada. Revisa el archivo reporte.csv para ver los resultados.")
